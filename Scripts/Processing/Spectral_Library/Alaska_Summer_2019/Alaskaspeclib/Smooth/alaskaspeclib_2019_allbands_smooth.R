...
write.csv(alaskaSpecLib_smooth_plants_more05 ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/2019/alaskaSpecLib_smooth_plants_more05.csv" , row.names = F)
write.csv(alaskaSpecLib_smooth_plants_more10 ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/2019/alaskaSpecLib_smooth_plants_more10.csv" , row.names = F)
write.csv(alaskaSpecLib_smooth_plants_more15 ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/2019/alaskaSpecLib_smooth_plants_more15.csv" , row.names = F)
write.csv(alaskaSpecLib_smooth_plants_more20 ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/2019/alaskaSpecLib_smooth_plants_more20.csv" , row.names = F)
write.csv(alaskaSpecLib_smooth_plants_equal05,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/2019/alaskaSpecLib_smooth_plants_equal05.csv", row.names = F)
write.csv(alaskaSpecLib_smooth_plants_equal10,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/2019/alaskaSpecLib_smooth_plants_equal10.csv", row.names = F)
write.csv(alaskaSpecLib_smooth_plants_equal15,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/2019/alaskaSpecLib_smooth_plants_equal15.csv", row.names = F)
write.csv(alaskaSpecLib_smooth_plants_equal20,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/2019/alaskaSpecLib_smooth_plants_equal20.csv", row.names = F)
