...
Murph_lib_spectra<-read_spectra("original_data/Alaska_Summer_2018/20180729/M_Dome",
                                format="sed")
...
## Smooth spectra
Murph_lib_spectra_smooth = smooth(Murph_lib_spectra)

## Trim ends and resample every 005nm, 010nm, 050nm and 100nm (Raw)
Murph_lib_spectra_005nm = resample(Murph_lib_spectra, seq(350, 2500, 5))
Murph_lib_spectra_010nm = resample(Murph_lib_spectra, seq(350, 2500, 10))
Murph_lib_spectra_050nm = resample(Murph_lib_spectra, seq(350, 2500, 50))
...
Murph_lib_spectra_smooth_005nm = resample(Murph_lib_spectra_smooth, seq(350, 2500, 5))
Murph_lib_spectra_smooth_010nm = resample(Murph_lib_spectra_smooth, seq(350, 2500, 10))
Murph_lib_spectra_smooth_050nm = resample(Murph_lib_spectra_smooth, seq(350, 2500, 50))
Murph_lib_spectra_smooth_100nm = resample(Murph_lib_spectra_smooth, seq(350, 2500, 100))

###save spectra (Raw)
saveRDS(Murph_lib_spectra      ,"Processed_spec/Alaska_Summer_2018//Murph_Lib/Murph_lib_spectra.rds")
saveRDS(Murph_lib_spectra_005nm,"Processed_spec/Alaska_Summer_2018/Murph_Lib/Murph_lib_spectra_005nm.rds")
saveRDS(Murph_lib_spectra_010nm,"Processed_spec/Alaska_Summer_2018/Murph_Lib/Murph_lib_spectra_010nm.rds")
saveRDS(Murph_lib_spectra_050nm,"Processed_spec/Alaska_Summer_2018/Murph_Lib/Murph_lib_spectra_050nm.rds")
saveRDS(Murph_lib_spectra_100nm,"Processed_spec/Alaska_Summer_2018/Murph_Lib/Murph_lib_spectra_100nm.rds")

###save spectra (Smooth)
saveRDS(Murph_lib_spectra_smooth      ,"Processed_spec/Alaska_Summer_2018/Murph_Lib/Murph_lib_spectra_smooth.rds")
saveRDS(Murph_lib_spectra_smooth_005nm,"Processed_spec/Alaska_Summer_2018/Murph_Lib/Murph_lib_spectra_smooth_005nm.rds")
saveRDS(Murph_lib_spectra_smooth_010nm,"Processed_spec/Alaska_Summer_2018/Murph_Lib/Murph_lib_spectra_smooth_010nm.rds")
saveRDS(Murph_lib_spectra_smooth_050nm,"Processed_spec/Alaska_Summer_2018/Murph_Lib/Murph_lib_spectra_smooth_050nm.rds")
saveRDS(Murph_lib_spectra_smooth_100nm,"Processed_spec/Alaska_Summer_2018/Murph_Lib/Murph_lib_spectra_smooth_100nm.rds")
