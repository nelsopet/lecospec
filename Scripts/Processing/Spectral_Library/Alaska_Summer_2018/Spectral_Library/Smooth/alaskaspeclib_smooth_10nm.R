...
AK2018_spectra    <- readRDS("Processed_spec/Alaska_Summer_2018/AK2018/AK2018_spectra_smooth_010nm.rds")
bethelLib_spectra <- readRDS("Processed_spec/Alaska_Summer_2018/bethelLib/bethelLib_spectra_smooth_010nm.rds")
brooksLib_spectra <- readRDS("Processed_spec/Alaska_Summer_2018/brooksLib/brooksLib_spectra_smooth_010nm.rds")
Murph2_spectra    <- readRDS("Processed_spec/Alaska_Summer_2018/Murph2_Lib/Murph2_spectra_smooth_010nm.rds")
Murph_lib_spectra <- readRDS("Processed_spec/Alaska_Summer_2018/Murph_lib/Murph_lib_spectra_smooth_010nm.rds")
yKDeltLib_spectra <- readRDS("Processed_spec/Alaska_Summer_2018/yKDeltLib/yKDeltLib_spectra_smooth_010nm.rds")
...
###save table
write.csv(alaskaSpecLib            ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/alaskaSpecLib_smooth_010nm_all.csv",row.names = FALSE)
write.csv(alaskaSpecLib_plants     ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/alaskaSpecLib_smooth_010nm_plants.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen     ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/alaskaSpecLib_smooth_010nm_lichen.csv",row.names = FALSE)
write.csv(alaskaSpecLib_bryo       ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/alaskaSpecLib_smooth_010nm_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen_bryo,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/alaskaSpecLib_smooth_010nm_lichen_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_vascular   ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Smooth/alaskaSpecLib_smooth_010nm_vascular.csv",row.names = FALSE)
