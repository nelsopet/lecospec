...
#Read in spectra_005nm for each area
...
###Convert spectra_005nm to dataframe
AK2018_spectra_005nm   <-as.data.frame(AK2018_spectra_005nm)
bethelLib_spectra_005nm<-as.data.frame(bethelLib_spectra_005nm)
brooksLib_spectra_005nm<-as.data.frame(brooksLib_spectra_005nm)
Murph2_spectra_005nm   <-as.data.frame(Murph2_spectra_005nm)
Murph_lib_spectra_005nm<-as.data.frame(Murph_lib_spectra_005nm)
yKDeltLib_spectra_005nm<-as.data.frame(yKDeltLib_spectra_005nm)

###Combine all dataframes from previous step
alaskaSpecLib<-rbind(AK2018_spectra_005nm,
...
##Add column PFT_2 (SPECIES) to spectra_005nml library
...
##Extracts scans for each life form (lichen, bryophyte, vascular plant) for spectra_005nml library
...
###save spectra_005nml library 
write.csv(alaskaSpecLib            ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_005nm_all.csv",row.names = FALSE)
write.csv(alaskaSpecLib_plants     ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_005nm_plants.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen     ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_005nm_lichen.csv",row.names = FALSE)
write.csv(alaskaSpecLib_bryo       ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_005nm_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen_bryo,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_005nm_lichen_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_vascular   ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_005nm_vascular.csv",row.names = FALSE)
