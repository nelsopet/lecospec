...
#Read in spectra_010nmfor each area
...
###Convert spectra_010nmto dataframe
AK2018_spectra_010nm  <-as.data.frame(AK2018_spectra_010nm)
bethelLib_spectra_010nm<-as.data.frame(bethelLib_spectra_010nm)
brooksLib_spectra_010nm<-as.data.frame(brooksLib_spectra_010nm)
Murph2_spectra_010nm  <-as.data.frame(Murph2_spectra_010nm)
Murph_lib_spectra_010nm<-as.data.frame(Murph_lib_spectra_010nm)
yKDeltLib_spectra_010nm<-as.data.frame(yKDeltLib_spectra_010nm)

###Combine all dataframes from previous step
alaskaSpecLib<-rbind(AK2018_spectra_010nm,
...
##Add column PFT_2 (SPECIES) to spectra_010nml library
...
##Extracts scans for each life form (lichen, bryophyte, vascular plant) for spectra_010nml library
...
###save spectra_010nml library 
write.csv(alaskaSpecLib            ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_010nm_all.csv",row.names = FALSE)
write.csv(alaskaSpecLib_plants     ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_010nm_plants.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen     ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_010nm_lichen.csv",row.names = FALSE)
write.csv(alaskaSpecLib_bryo       ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_010nm_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen_bryo,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_010nm_lichen_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_vascular   ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_010nm_vascular.csv",row.names = FALSE)
