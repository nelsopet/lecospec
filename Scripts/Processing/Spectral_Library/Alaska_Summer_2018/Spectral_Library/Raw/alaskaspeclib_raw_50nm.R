...
#Read in spectra_050nmfor each area
...
###Convert spectra_050nmto dataframe
AK2018_spectra_050nm  <-as.data.frame(AK2018_spectra_050nm)
bethelLib_spectra_050nm<-as.data.frame(bethelLib_spectra_050nm)
brooksLib_spectra_050nm<-as.data.frame(brooksLib_spectra_050nm)
Murph2_spectra_050nm  <-as.data.frame(Murph2_spectra_050nm)
Murph_lib_spectra_050nm<-as.data.frame(Murph_lib_spectra_050nm)
yKDeltLib_spectra_050nm<-as.data.frame(yKDeltLib_spectra_050nm)

###Combine all dataframes from previous step
alaskaSpecLib<-rbind(AK2018_spectra_050nm,
...
##Add column PFT_2 (SPECIES) to spectra_050nml library
...
##Extracts scans for each life form (lichen, bryophyte, vascular plant) for spectra_050nml library
...
###save spectra_050nml library 
write.csv(alaskaSpecLib            ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_050nm_all.csv",row.names = FALSE)
write.csv(alaskaSpecLib_plants     ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_050nm_plants.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen     ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_050nm_lichen.csv",row.names = FALSE)
write.csv(alaskaSpecLib_bryo       ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_050nm_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen_bryo,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_050nm_lichen_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_vascular   ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_050nm_vascular.csv",row.names = FALSE)
