...
#Read in spectra_50nmfor each area
...
###Convert spectra_50nmto dataframe
AK2018_spectra_100nm  <-as.data.frame(AK2018_spectra_100nm)
bethelLib_spectra_100nm<-as.data.frame(bethelLib_spectra_100nm)
brooksLib_spectra_100nm<-as.data.frame(brooksLib_spectra_100nm)
Murph2_spectra_100nm  <-as.data.frame(Murph2_spectra_100nm)
Murph_lib_spectra_100nm<-as.data.frame(Murph_lib_spectra_100nm)
yKDeltLib_spectra_100nm<-as.data.frame(yKDeltLib_spectra_100nm)

###Combine all dataframes from previous step
alaskaSpecLib<-rbind(AK2018_spectra_100nm,
...
##Add column PFT_2 (SPECIES) to spectra_100nml library
...
##Extracts scans for each life form (lichen, bryophyte, vascular plant) for spectra_100nml library
...
###save spectra_100nml library 
write.csv(alaskaSpecLib            ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_100nm_all.csv",row.names = FALSE)
write.csv(alaskaSpecLib_plants     ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_100nm_plants.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen     ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_100nm_lichen.csv",row.names = FALSE)
write.csv(alaskaSpecLib_bryo       ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_100nm_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen_bryo,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_100nm_lichen_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_vascular   ,"Processed_spec/AlaskaSpecLib/Spectral_Library/Raw/alaskaSpecLib_100nm_vascular.csv",row.names = FALSE)
