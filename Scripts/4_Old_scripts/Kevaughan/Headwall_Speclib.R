...
##Lets save our new resampled spectral library as a dataframe
alaskaSpecLib_HDW_df<-alaskaSpecLib_HDW%>%as.data.frame()%>%dplyr::select(-sample_name)
...
saveRDS(alaskaSpecLib_HDW             ,"Outputs/2_HDW_Imagery/1_Processing/alaskaSpeclib_HDW.rds")
write.csv(alaskaSpecLib_HDW_df        ,"Outputs/2_HDW_Imagery/1_Processing/alaskaSpecLib_HDW_df.csv"        ,row.names = FALSE)
write.csv(alaskaSpecLib_HDW_df_equal25,"Outputs/2_HDW_Imagery/1_Processing/alaskaSpecLib_HDW_df_equal25.csv",row.names = FALSE)
write(Headwall_wv                     ,"Outputs/2_HDW_Imagery/1_Processing/Headwall_wv")
