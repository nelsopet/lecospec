...
jpeg('Outputs/3_AV_Imagery/2_Models/PC Feature importance.jpg',width=1000, height=700)
...
###save plot as a jpeg
jpeg('Outputs/3_AV_Imagery/2_Models/Plot of PCA Model Prediction.jpg',width=1000, height=700)
par(xpd = FALSE)
plot(
