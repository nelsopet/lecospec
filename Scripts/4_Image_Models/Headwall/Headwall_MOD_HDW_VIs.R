...
jpeg('Outputs/2_HDW_Imagery/2_Models/VIs Feature importance.jpg',width=800, height=600)
...
jpeg('Outputs/2_HDW_Imagery/2_Models/Plot of Vegiation Index Model Prediction.jpg',width=1000, height=700)
par(xpd = FALSE)
plot(
  ...
  xaxt = 'n',
  yaxt = 'n',
  main = "Plot of Vegiation Index Model Prediction"
)

par(xpd = TRUE)
legend(
  "right",
  legend = c("Dwarf Shrub","Shrub","moss","Tree","Forb"),
  fill = c(
    "lightcyan3",
    "royalblue",
    "forestgreen",
