...
alaskaSpecLib<-read.csv("Outputs/1_Field_spec/MSGC_SPECTRA.csv",check.names = F)
...
##Lichen
jpeg("Test_Outputs/1_Field_spec/1_Processing/Graphs_SpecProfiles/Lichen.jpg", units="px", height = 1400, width=2400, res=350)
alaskaSpecLib_Lichen%>%
  group_by(Species, Wavelength) %>% mutate(Median_Reflectance = median(Reflectance)) %>% 
  ggplot(aes(Wavelength,Median_Reflectance))+geom_line(aes(color=Species))+ 
...
##Tree
jpeg("Outputs/1_Field_spec/Tree_MSGC.jpg", units="px", height = 1400, width=2400, res=350)
alaskaSpecLib_Tree%>%
  group_by(Species, Wavelength) %>% mutate(Median_Reflectance = median(Reflectance)) %>% 
  ggplot(aes(Wavelength,Median_Reflectance))+geom_line(aes(color=Species))+
...
##Dwarf Shrub
jpeg("Test_Outputs/1_Field_spec/1_Processing/Graphs_SpecProfiles/Dwarf Shrub.jpg", units="px", height = 1400, width=2400, res=350)
...
##Shrub
jpeg("Test_Outputs/1_Field_spec/1_Processing/Graphs_SpecProfiles/Shrub.jpg", units="px", height = 1400, width=2400, res=350)
alaskaSpecLib_shrub%>%
  group_by(Species, Wavelength) %>% mutate(Median_Reflectance = median(Reflectance)) %>% 
  ggplot(aes(Wavelength,Median_Reflectance))+geom_line(aes(color=Species))+
  theme(panel.background = element_rect(fill = "white", colour = "grey50"),legend.key.size = unit(0.4, "cm"),legend.text = element_text(size=5))+
...
##Moss
jpeg("Test_Outputs/1_Field_spec/1_Processing/Graphs_SpecProfiles/Moss.jpg", units="px", height = 1400, width=2400, res=350)
alaskaSpecLib_Moss%>%
  group_by(Species, Wavelength) %>% mutate(Median_Reflectance = median(Reflectance)) %>% 
  ggplot(aes(Wavelength,Median_Reflectance))+geom_line(aes(color=Species))+
  theme(panel.background = element_rect(fill = "white", colour = "grey50"),legend.key.size = unit(0.4, "cm"),legend.text = element_text(size=5))+
...
##Graminoid
jpeg("Test_Outputs/1_Field_spec/1_Processing/Graphs_SpecProfiles/Graminoid.jpg", units="px", height = 1400, width=2400, res=350)
...
##Forb
jpeg("Test_Outputs/1_Field_spec/1_Processing/Graphs_SpecProfiles/Forb.jpg", units="px", height = 1400, width=2400, res=350)
alaskaSpecLib_Forb%>%
  group_by(Species, Wavelength) %>% mutate(Median_Reflectance = median(Reflectance)) %>% 
  ggplot(aes(Wavelength,Median_Reflectance))+geom_line(aes(color=Species))+
