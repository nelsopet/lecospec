...
alaskaSpecLib_plants<-subset(alaskaSpecL
                             ##ib_plants, alaskaSpecLib_plants$'1894'<2) 
...
##PCA
PCA_preds_equal10<-PCA_preds %>% group_by(PFT_3) %>% sample_n(10,replace = TRUE)
PCA_preds_equal15<-PCA_preds %>% group_by(PFT_3) %>% sample_n(15,replace = TRUE)
PCA_preds_equal20<-PCA_preds %>% group_by(PFT_3) %>% sample_n(20,replace = TRUE)

PCA_preds_equal10_smooth<-PCA_preds_smooth %>% group_by(PFT_3) %>% sample_n(10,replace = TRUE)
PCA_preds_equal15_smooth<-PCA_preds_smooth %>% group_by(PFT_3) %>% sample_n(15,replace = TRUE)
PCA_preds_equal20_smooth<-PCA_preds_smooth %>% group_by(PFT_3) %>% sample_n(20,replace = TRUE)

PCA_preds_equal10_smooth_05nm<-PCA_preds_smooth_05nm %>% group_by(PFT_3) %>% sample_n(10,replace = TRUE)
PCA_preds_equal15_smooth_05nm<-PCA_preds_smooth_05nm %>% group_by(PFT_3) %>% sample_n(15,replace = TRUE)
PCA_preds_equal20_smooth_05nm<-PCA_preds_smooth_05nm %>% group_by(PFT_3) %>% sample_n(20,replace = TRUE)
