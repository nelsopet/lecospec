...
EightMile_HDW  <-read.csv("Outputs/2_HDW_Imagery/1_Processing/EightMile_HDW_df.csv",check.names = FALSE)
...
write.csv(EightMile_VIs_A             ,"Outputs/2_HDW_Imagery/1_Processing/EightMile_HDW_VIs.csv"         ,row.names = FALSE)
