...
##Notice that the resampled dataframes have less observations (pixels) than the vegitation idices
##We need to fix this can be done using an inner join
EightMile_data_HDW<-inner_join(EightMile_data_HDW,EightMile_VIs_A)
