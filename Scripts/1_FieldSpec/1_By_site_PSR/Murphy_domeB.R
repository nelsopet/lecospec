...
Murphy_domeB_spectra<-read_spectra("Original_data/Field_spec/Murphy_domeB/original_samples",
                           format="sed")
...
##save spectra (Raw)
saveRDS(Murphy_domeB_spectra      ,"OutputsPSR/Processing/PSR/Murphy_domeB_spectra.rds")
