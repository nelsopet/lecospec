...
Big_Trail_Lake_spectra<-read_spectra("Original_data/Field_spec/Big_Trail_Lake/original_samples",
                                 format="sed")
...
##save spectra (Raw)
saveRDS(Big_Trail_Lake_spectra      ,"OutputsPSR/Processing/PSR/Big_Trail_Lake_spectra.rds"      )
