...
Eagle_summit_spectra<-read_spectra("Original_data/Field_spec/Eagle_summit/original_samples",
                                     format="sed")
...
##save spectra (Raw)
saveRDS(Eagle_summit_spectra      ,"OutputsPSR/Processing/PSR/Eagle_summit_spectra.rds"      )
