...
bg_filepath <- "./Output/dev_FullCube/bg_1511_fncgrp1_PREDICTIONS_img_balanced_2tree_ranger.tif"
...
ggsave("./bg_map_ranger_img_raw_balanced_2tree.png")
...
ggsave("./em_2tree_ranger_img_raw_balanced_map.png")
...
ca_filepath <- "./Output/dev_FullCube/ch_0_fncgrp1_PREDICTIONS_img_balanced_2tree_ranger_2.tif"
...
ggsave("./ca_2tree_ranger_img_raw_balanced_map_2.png")
...
ggsave("./bz_2tree_ranger_img_raw_balanced_map_2.png")
