...
img_num = 7 # Pick up at 85 later and stop at 95
...
quad_results <- estimate_land_cover(
  test_path, 
  output_filepath = "./test/test_pred_adaboost_all_datacube_run_100130_0.grd",
...
test_tif<-as_tiff("test_pred_adaboost_all_datacube_run_100130_0")
plot(test_tif)
