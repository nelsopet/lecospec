...
##I could use a function to read in all the spectra from each location (a loop maybe)
#This way they woudld be seperate objects in our environment
...
AK2018_spectra          <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/AK2018_spectra.rds"          )##SPECTRAL OBJECT WITH 99 SAMPLES
bethelLib_spectra       <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/bethelLib_spectra.rds"       )##SPECTRAL OBJECT WITH 60 SAMPLES
brooksLib_spectra       <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/brooksLib_spectra.rds"       )##SPECTRAL OBJECT WITH 132 SAMPLES
Murph2_spectra          <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/Murph2_spectra.rds"          )##SPECTRAL OBJECT WITH 140 SAMPLES
Murph_lib_spectra       <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/Murph_lib_spectra.rds"       )##SPECTRAL OBJECT WITH 249 SAMPLES
yKDeltLib_spectra       <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/yKDeltLib_spectra.rds"       )##SPECTRAL OBJECT WITH 183 SAMPLES
TwelveMile_spectra      <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/TwelveMile_spectra.rds"      )##SPECTRAL OBJECT WITH 73 SAMPLES
Big_Trail_Lake_spectra  <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/Big_Trail_Lake_spectra.rds"  )##SPECTRAL OBJECT WITH 82 SAMPLES
Eagle_summit_spectra    <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/Eagle_summit_spectra.rds"    )##SPECTRAL OBJECT WITH 467 SAMPLES
Murphy_domeA_spectra    <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/Murphy_domeA_spectra.rds"    )##SPECTRAL OBJECT WITH 83 SAMPLES
Murphy_domeB_spectra    <-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/Murphy_domeB_spectra.rds"    )##SPECTRAL OBJECT WITH 52 SAMPLES
Wickersham_domeA_spectra<-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/Wickersham_domeA_spectra.rds")##SPECTRAL OBJECT WITH 132 SAMPLES
Wickersham_domeB_spectra<-readRDS("Outputs/1_Field_spec/1_Processing/PSR_data/PSR_UnprocessedSpec/Wickersham_domeB_spectra.rds")##SPECTRAL OBJECT WITH 233 SAMPLES
...
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="abibal"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="acerub"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="acepen"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="aleoch"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="alnfru"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="alninc"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="arccen"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="arcnig"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="arcrub"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="arcsta"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="arctop"]<-"Unknown"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="asachr"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="aulpal"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="aultur"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="bare rock"]<-"Abiotic"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="bare_soil"]<-"Abiotic"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="betall"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="betnan"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="betneo"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="betpap"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="betpop"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="bryoria"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="calcan"]<-"Graminoid"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="carlin"]<-"Graminoid"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="carlyn"]<-"Graminoid"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="carram"]<-"Graminoid"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="castet"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="cerpur"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="cetisl"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="cetlae"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="claama"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="clacor"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="clacuc"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="clagra"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="clamit"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="claran"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="claste"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="clasty"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="clasul"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="claunc"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="dacarc"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="dead salix"]<-"Abiotic"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="dicranum"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="dryala"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="dryhyb"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="dryoct"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="empnig"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="equarv"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="equsyl"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="erivag"]<-"Graminoid"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="evemes"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="faggra"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="flacuc"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="flaniv"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="fraame"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="gravel"]<-"Abiotic"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="grey_rhizocarpon"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="herlan"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="hylspl"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="hypaus"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="hypspl"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="icmeri"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="irisit"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="larlar"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="leddec"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="loipro"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="luparc"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="masric"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="melanelia"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="melhep"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="neparc"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="naparc"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="orange_Porpidia"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="paramb"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="paromp"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="parsul"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="pedrac"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="pedsud"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="pelapt"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="pelleu"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="pelmal"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="pelsca"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="petfri"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="picmar"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="picrub"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="pilaci"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="pinstr"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="plagiomnium"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="popbal"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="popgra"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="prupen"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="plesch"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="poljen"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="poljun"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="polstr"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="polytrichum"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="popbal"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="quartz"]<-"Abiotic"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="querub"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="raclan"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="rhigeo"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="rhyrug"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="rhutyp"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="rosaci"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="rosasc"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="rubcam"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="rubcha"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="salala"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="salarb"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="salgla"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="sallan"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="salova"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="Salova"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="salpul"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="salric"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="sphagn"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="sphfus"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="spruce bark"]<-"Abiotic"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="stepas"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="stetas"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="thuocc"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="toefeldia"]<-"Forb"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="tomnit"]<-"Moss"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="tragra"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="tsucan"]<-"Tree"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="umbarc"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="umbhyp"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="usnlap"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="usnsca"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="vacvit"]<-"Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="vaculi"]<-"Dwarf Shrub"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="vulpin"]<-"Lichen"
alaskaSpecLib$PFT_4[alaskaSpecLib$PFT=="wooly_salix"]<-"Shrub"
...
alaskaSpecLibPFT4_freqTab<-as.data.frame(table(alaskaSpecLib$PFT_4))
...
alaskaSpecLib$Freq3<-alaskaSpecLibPFT4_freqTab$Freq[match(alaskaSpecLib$PFT_4,alaskaSpecLibPFT4_freqTab$Var1)]

##Lets reorder the columns so our data is a little more structured...dim () 1985 2158 
alaskaSpecLib<-alaskaSpecLib%>%dplyr::select(ScanID,PFT,PFT_2,PFT_3,PFT_4,Freq1,Freq2,Freq3,everything())
...
tst<-lapply(alaskaSpecLib[-1:-9],range)%>%as.data.frame%>%t()%>%as.data.frame
tst$V1%>%range()
...
badscans<-c("1891"  ,"1892" ,"1893" ,"1894" ,"1895" ,"1896" ,"1897" ,"1898" ,"1899" ,"1900" ,"1901" ,"1902" ,"1908" ,"1909"
            ...
            ,"2491" ,"2492" ,"2493" ,"2497" ,"2498" ,"2499" ,"2500")###There should be a better way to do this***
...
#Forb               80
#Graminoid_Grass    4
#Graminoid_Sedge    21 there were 5 bad scans in this group
#Lichen_Dark        173
#Lichen_Light       90
#Lichen_Yellow      206
#Moss_Acrocarp      55
...
alaskaSpecLib_df_species<-alaskaSpecLib_df%>%dplyr::select(PFT,PFT_2,PFT_3,PFT_4)
write.csv(alaskaSpecLib_df_species                 ,"Outputs/1_Field_spec/1_Processing/PSR_data/PSR_ProcessedSpec/alaskaSpecLib_df_species.csv", row.names = FALSE)

####Lets run that test again just to make sure our function worked
tst<-lapply(alaskaSpecLib_df[-1:-9],range)%>%as.data.frame%>%t()%>%as.data.frame
...
alaskaSpecLib<-spectrolab::as.spectra(alaskaSpecLib_df[,c(-1:-9)])
##str(alaskaSpecLib_spectra)

##bind metadata...final product is a spectral object with 1975 samples with spectral range of 350-2500nm and  6 variables being metadata
meta(alaskaSpecLib)<-data.frame(alaskaSpecLib_df[,c(1:9)], stringsAsFactors = FALSE)
...
Species_table<-alaskaSpecLib_df %>%
  ...
  count(PFT_2)
#View(Species_table)
#write.csv(Species_table, "Outputs/1_Field_spec/1_Processing/PSR_data/PSR_ProcessedSpec/SpeciesPer_group.csv")

##lets create df a dataframe for each functional group based on the species count from above
##We want each group (PFT3) to have equal amounts of species (PFT2)
##Need to find a better wy to do this...with functional coding
...
##Here we use the median value across all the species within each group
...
##Lets chek to see how many scans there are per functional group
##These will be used in our random forest models later
ScansPer_group<-alaskaSpecLib_reduced_df %>%
  group_by(PFT_3) %>%
  count(PFT_3)
##View(ScansPer_group)
#write.csv(ScansPer_group, "Outputs/1_Field_spec/1_Processing/PSR_data/PSR_ProcessedSpec/ScansPer_group.csv")

##Lets convert our new spectral library to a spectral object to ne used later 
alaskaSpecLib_reduced <-spectrolab::as.spectra(alaskaSpecLib_reduced_df[-1:-9])
meta(alaskaSpecLib_reduced)<-data.frame(alaskaSpecLib_reduced_df[1:9], stringsAsFactors = FALSE)###adds metadata
...
saveRDS(alaskaSpecLib                 ,"Outputs/1_Field_spec/1_Processing/PSR_data/PSR_ProcessedSpec/alaskaSpecLib.rds"                               )
saveRDS(alaskaSpecLib_reduced         ,"Outputs/1_Field_spec/1_Processing/PSR_data/PSR_ProcessedSpec/alaskaSpecLib_reduced.rds"                       )

write.csv(alaskaSpecLib_df            ,"Outputs/1_Field_spec/1_Processing/PSR_data/PSR_ProcessedSpec/alaskaSpecLib_df.csv"              ,row.names = F)
write.csv(alaskaSpecLib_reduced_df    ,"Outputs/1_Field_spec/1_Processing/PSR_data/PSR_ProcessedSpec/alaskaSpecLib_reduced_df.csv"      ,row.names = F)
