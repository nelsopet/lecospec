...
##Need to run all scripts in folder "1_Field_spec_processing/1_By_site_PSR" prior this script if the data is not present in the output folder below
...
Species_groups<-read.csv("Outputs/Field_spec/Processing/PSR/SpecLib_groups.csv")

# Creates a file path to where our spectral libraries for each site is loacated
# Data collected in 2018 and 2019
mypath_atkin = "Outputs/Field_spec/Processing/PSR/"
