...
alaskaSpeclib_HDW_005nm<-cbind(alaskaSpeclib_HDW_df[1:9],alaskaSpeclib_HDW_005nm)
alaskaSpeclib_HDW_010nm<-cbind(alaskaSpeclib_HDW_df[1:9],alaskaSpeclib_HDW_010nm)
alaskaSpeclib_HDW_050nm<-cbind(alaskaSpeclib_HDW_df[1:9],alaskaSpeclib_HDW_050nm)
alaskaSpeclib_HDW_100nm<-cbind(alaskaSpeclib_HDW_df[1:9],alaskaSpeclib_HDW_100nm)

####Lets run logical test for all datarames
tst5<-lapply(alaskaSpeclib_HDW_050nm[-1:-9],range)%>%as.data.frame%>%t()%>%as.data.frame
...
####Lets run logical test for all datarames
tst2<-lapply(alaskaSpeclib_HDW_010nm[-1:-9],range)%>%as.data.frame%>%t()%>%as.data.frame
...
tst3<-lapply(alaskaSpeclib_HDW_050nm[-1:-9],range)%>%as.data.frame%>%t()%>%as.data.frame
...
####Lets run that test on "alaskaSpeclib_HDW_10nm"
tst4<-lapply(alaskaSpeclib_HDW_100nm[-1:-9],range)%>%as.data.frame%>%t()%>%as.data.frame
