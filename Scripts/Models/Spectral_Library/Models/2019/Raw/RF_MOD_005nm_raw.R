...
names(species_005nm_error_more05)[2]<-"Raw_005nm"
names(species_005nm_error_more10)[2]<-"Raw_005nm"
names(species_005nm_error_more15)[2]<-"Raw_005nm"
names(species_005nm_error_more20)[2]<-"Raw_005nm"

names(PCA_species_005nm_error_more05)[2]<-"Raw_PCA_005nm"
names(PCA_species_005nm_error_more10)[2]<-"Raw_PCA_005nm"
names(PCA_species_005nm_error_more15)[2]<-"Raw_PCA_005nm"
names(PCA_species_005nm_error_more20)[2]<-"Raw_PCA_005nm"

#Creates dataframe showing the OOB estimate of error rate of the model
Overall_005nm_error_more05<-rf_005nm_more05$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("Raw"))%>%mutate(Category="005nm_more05")
Overall_005nm_error_more10<-rf_005nm_more10$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("Raw"))%>%mutate(Category="005nm_more10")
Overall_005nm_error_more15<-rf_005nm_more15$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("Raw"))%>%mutate(Category="005nm_more15")
Overall_005nm_error_more20<-rf_005nm_more20$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("Raw"))%>%mutate(Category="005nm_more20")

PCA_Overall_005nm_error_more05<-PCA_rf_005nm_more05$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("PCA"))%>%mutate(Category="005nm_more05")
PCA_Overall_005nm_error_more10<-PCA_rf_005nm_more10$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("PCA"))%>%mutate(Category="005nm_more10")
PCA_Overall_005nm_error_more15<-PCA_rf_005nm_more15$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("PCA"))%>%mutate(Category="005nm_more15")
PCA_Overall_005nm_error_more20<-PCA_rf_005nm_more20$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("PCA"))%>%mutate(Category="005nm_more20")
...
##Changes column name class.error 
names(species_005nm_error_equal05)[2]<-"Raw_005nm"
names(species_005nm_error_equal10)[2]<-"Raw_005nm"
names(species_005nm_error_equal15)[2]<-"Raw_005nm"
names(species_005nm_error_equal20)[2]<-"Raw_005nm"

names(PCA_species_005nm_error_equal05)[2]<-"Raw_PCA_005nm"
names(PCA_species_005nm_error_equal10)[2]<-"Raw_PCA_005nm"
names(PCA_species_005nm_error_equal15)[2]<-"Raw_PCA_005nm"
names(PCA_species_005nm_error_equal20)[2]<-"Raw_PCA_005nm"


#Creates dataframe showing the OOB estimate of error rate of the model
Overall_005nm_error_equal05<-rf_005nm_equal05$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("Raw"))%>%mutate(Category="005nm_equal05")
Overall_005nm_error_equal10<-rf_005nm_equal10$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("Raw"))%>%mutate(Category="005nm_equal10")
Overall_005nm_error_equal15<-rf_005nm_equal15$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("Raw"))%>%mutate(Category="005nm_equal15")
Overall_005nm_error_equal20<-rf_005nm_equal20$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("Raw"))%>%mutate(Category="005nm_equal20")

PCA_Overall_005nm_error_equal05<-PCA_rf_005nm_equal05$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("PCA"))%>%mutate(Category="005nm_equal05")
PCA_Overall_005nm_error_equal10<-PCA_rf_005nm_equal10$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("PCA"))%>%mutate(Category="005nm_equal10")
PCA_Overall_005nm_error_equal15<-PCA_rf_005nm_equal15$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("PCA"))%>%mutate(Category="005nm_equal15")
PCA_Overall_005nm_error_equal20<-PCA_rf_005nm_equal20$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("PCA"))%>%mutate(Category="005nm_equal20")
...
ModelOOB_005nm_raw_spec<-rbind(Overall_005nm_error_more05
...
ModeModelOOB_005nm_PCA_spec<-rbind(PCA_Overall_005nm_error_equal05
                                  ,PCA_Overall_005nm_error_equal10
                                  ,PCA_Overall_005nm_error_equal15
                                  ,PCA_Overall_005nm_error_equal20
                                  ,PCA_Overall_005nm_error_more05
                                  ,PCA_Overall_005nm_error_more10
                                  ,PCA_Overall_005nm_error_more15
                                  ,PCA_Overall_005nm_error_more20)

ModelOOB_005nm_raw<-merge(ModelOOB_005nm_raw_spec,ModeModelOOB_005nm_PCA_spec,by="Category")
