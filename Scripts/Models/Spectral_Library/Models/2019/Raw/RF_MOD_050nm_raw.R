...
alaskaSpecLib_050nm_plants_equal20$PFT_2<-as.factor(pca_050nm_plants_equal20$PFT_2)
...
names(species_050nm_error_more05)[2]<-"raw_050nm_more05"
names(species_050nm_error_more10)[2]<-"raw_050nm_more10"
names(species_050nm_error_more15)[2]<-"raw_050nm_more15"
names(species_050nm_error_more20)[2]<-"raw_050nm_more20"

names(PCA_species_050nm_error_more05)[2]<-"raw_PCA_more05"
names(PCA_species_050nm_error_more10)[2]<-"raw_PCA_more10"
names(PCA_species_050nm_error_more15)[2]<-"raw_PCA_more15"
names(PCA_species_050nm_error_more20)[2]<-"raw_PCA_more20"

#Creates dataframe showing the OOB estimate of error rate of the model
Overall_050nm_error_more05<-rf_050nm_more05$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_050nm_more05"))%>%mutate(Category="050nm_bands")
Overall_050nm_error_more10<-rf_050nm_more10$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_050nm_more10"))%>%mutate(Category="050nm_bands")
Overall_050nm_error_more15<-rf_050nm_more15$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_050nm_more15"))%>%mutate(Category="050nm_bands")
Overall_050nm_error_more20<-rf_050nm_more20$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_050nm_more20"))%>%mutate(Category="050nm_bands")

PCA_Overall_050nm_error_more05<-PCA_rf_050nm_more05$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_PCA_more05"))%>%mutate(Category="050nm_bands")
PCA_Overall_050nm_error_more10<-PCA_rf_050nm_more10$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_PCA_more10"))%>%mutate(Category="050nm_bands")
PCA_Overall_050nm_error_more15<-PCA_rf_050nm_more15$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_PCA_more15"))%>%mutate(Category="050nm_bands")
PCA_Overall_050nm_error_more20<-PCA_rf_050nm_more20$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_PCA_more20"))%>%mutate(Category="050nm_bands")
  
##Subset all the species that had an error rate lower than 30%
species_050nm_error_more05_below30<-subset(species_050nm_error_more05,raw_050nm_more05<0.3)
species_050nm_error_more10_below30<-subset(species_050nm_error_more10,raw_050nm_more10<0.3)
species_050nm_error_more15_below30<-subset(species_050nm_error_more15,raw_050nm_more15<0.3)
species_050nm_error_more20_below30<-subset(species_050nm_error_more20,raw_050nm_more20<0.3)

PCA_species_050nm_error_more05_below30<-subset(PCA_species_050nm_error_more05,raw_PCA_more05<0.3)
PCA_species_050nm_error_more10_below30<-subset(PCA_species_050nm_error_more10,raw_PCA_more10<0.3)
PCA_species_050nm_error_more15_below30<-subset(PCA_species_050nm_error_more15,raw_PCA_more15<0.3)
PCA_species_050nm_error_more20_below30<-subset(PCA_species_050nm_error_more20,raw_PCA_more20<0.3)
...
##Changes column name class.error 
names(species_050nm_error_equal05)[2]<-"raw_050nm_equal05"
names(species_050nm_error_equal10)[2]<-"raw_050nm_equal10"
names(species_050nm_error_equal15)[2]<-"raw_050nm_equal15"
names(species_050nm_error_equal20)[2]<-"raw_050nm_equal20"

names(PCA_species_050nm_error_equal05)[2]<-"raw_PCA_equal05"
names(PCA_species_050nm_error_equal10)[2]<-"raw_PCA_equal10"
names(PCA_species_050nm_error_equal15)[2]<-"raw_PCA_equal15"
names(PCA_species_050nm_error_equal20)[2]<-"raw_PCA_equal20"


#Creates dataframe showing the OOB estimate of error rate of the model
Overall_050nm_error_equal05<-rf_050nm_equal05$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_050nm_equal05"))%>%mutate(Category="050nm_bands")
Overall_050nm_error_equal10<-rf_050nm_equal10$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_050nm_equal10"))%>%mutate(Category="050nm_bands")
Overall_050nm_error_equal15<-rf_050nm_equal15$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_050nm_equal15"))%>%mutate(Category="050nm_bands")
Overall_050nm_error_equal20<-rf_050nm_equal20$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_050nm_equal20"))%>%mutate(Category="050nm_bands")
m_bands
PCA_Overall_050nm_error_equal05<-PCA_rf_050nm_equal05$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_PCA_equal05"))%>%mutate(Category="050nm_bands")
PCA_Overall_050nm_error_equal10<-PCA_rf_050nm_equal10$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_PCA_equal10"))%>%mutate(Category="050nm_bands")
PCA_Overall_050nm_error_equal15<-PCA_rf_050nm_equal15$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_PCA_equal15"))%>%mutate(Category="050nm_bands")
PCA_Overall_050nm_error_equal20<-PCA_rf_050nm_equal20$err.rate[2001,1]%>%as.data.frame()%>%setNames(.,c("raw_PCA_equal20"))%>%mutate(Category="050nm_bands")
  
##Subset all the species that had an error rate lower than 30%
species_050nm_error_equal05_below30<-subset(species_050nm_error_equal05,raw_050nm_equal05<0.3)
species_050nm_error_equal10_below30<-subset(species_050nm_error_equal10,raw_050nm_equal10<0.3)
species_050nm_error_equal15_below30<-subset(species_050nm_error_equal15,raw_050nm_equal15<0.3)
species_050nm_error_equal20_below30<-subset(species_050nm_error_equal20,raw_050nm_equal20<0.3)

PCA_species_050nm_error_equal05_below30<-subset(PCA_species_050nm_error_equal05,raw_PCA_equal05<0.3)
PCA_species_050nm_error_equal10_below30<-subset(PCA_species_050nm_error_equal10,raw_PCA_equal10<0.3)
PCA_species_050nm_error_equal15_below30<-subset(PCA_species_050nm_error_equal15,raw_PCA_equal15<0.3)
PCA_species_050nm_error_equal20_below30<-subset(PCA_species_050nm_error_equal20,raw_PCA_equal20<0.3)
...
ModelOOB_050nm_raw<-Reduce(function(x,y) merge(x,y,by="Category",all=TRUE) ,list(Overall_050nm_error_more05
                                                                                    ...
                                                                                    ,PCA_Overall_050nm_error_equal05
...
write.csv(species_050nm_error_more05_below30  ,"Processed_spec/Error_rates/Raw/species_050nm_error_more05_below30_raw.csv", row.names = F)
write.csv(species_050nm_error_more10_below30  ,"Processed_spec/Error_rates/Raw/species_050nm_error_more10_below30_raw.csv", row.names = F)
write.csv(species_050nm_error_more15_below30  ,"Processed_spec/Error_rates/Raw/species_050nm_error_more15_below30_raw.csv", row.names = F)
write.csv(species_050nm_error_more20_below30  ,"Processed_spec/Error_rates/Raw/species_050nm_error_more20_below30_raw.csv", row.names = F)

write.csv(PCA_species_050nm_error_more05_below30  ,"Processed_spec/Error_rates/Raw/PCA_species_050nm_error_more05_below30_raw.csv", row.names = F)
write.csv(PCA_species_050nm_error_more10_below30  ,"Processed_spec/Error_rates/Raw/PCA_species_050nm_error_more10_below30_raw.csv", row.names = F)
write.csv(PCA_species_050nm_error_more15_below30  ,"Processed_spec/Error_rates/Raw/PCA_species_050nm_error_more15_below30_raw.csv", row.names = F)
write.csv(PCA_species_050nm_error_more20_below30  ,"Processed_spec/Error_rates/Raw/PCA_species_050nm_error_more20_below30_raw.csv", row.names = F)

write.csv(species_050nm_error_equal05_below30  ,"Processed_spec/Error_rates/Raw/species_050nm_error_equal05_below30_raw.csv", row.names = F)
write.csv(species_050nm_error_equal10_below30  ,"Processed_spec/Error_rates/Raw/species_050nm_error_equal10_below30_raw.csv", row.names = F)
write.csv(species_050nm_error_equal15_below30  ,"Processed_spec/Error_rates/Raw/species_050nm_error_equal15_below30_raw.csv", row.names = F)
write.csv(species_050nm_error_equal20_below30  ,"Processed_spec/Error_rates/Raw/species_050nm_error_equal20_below30_raw.csv", row.names = F)

write.csv(PCA_species_050nm_error_equal05_below30  ,"Processed_spec/Error_rates/Raw/PCA_species_050nm_error_equal05_below30_raw.csv", row.names = F)
write.csv(PCA_species_050nm_error_equal10_below30  ,"Processed_spec/Error_rates/Raw/PCA_species_050nm_error_equal10_below30_raw.csv", row.names = F)
write.csv(PCA_species_050nm_error_equal15_below30  ,"Processed_spec/Error_rates/Raw/PCA_species_050nm_error_equal15_below30_raw.csv", row.names = F)
write.csv(PCA_species_050nm_error_equal20_below30  ,"Processed_spec/Error_rates/Raw/PCA_species_050nm_error_equal20_below30_raw.csv", row.names = F)
