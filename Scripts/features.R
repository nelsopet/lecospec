...
img_indices <- impute_spectra(get_vegetation_indices(img_bands, NULL))# should have a default of NULL, you know?
...
X11();heatmap(cor(img_indices))
X11();heatmap(cor(img_resampled_bands))
