...
jpeg('Outputs/2_HDW_Imagery/2_Models/05nm_bands Feature importance_HDW.jpg',width=800, height=600)
ggplot(feat_imp_df, aes(x = reorder(feature, MeanDecreaseGini), 
  ...
  labs(
    x     = "Feature",
    y     = "Importance",
    title = "Feature Importance: HDW Randomforest_MOD using 5nm_bands as predictors"
  )
dev.off()
...
ggplot(feat_imp_df, aes(x = reorder(feature, MeanDecreaseGini), 
  ...
  labs(
    x     = "Feature",
    y     = "Importance",
    title = "Feature Importance:HDW Randomforest_MOD using 10nm_bands as predictors"
  )
dev.off()
...
jpeg('Outputs/2_HDW_Imagery/2_Models/Plot of 05nm Model_HDW.jpg',width=1000, height=700)
par(xpd = FALSE)
plot(
  ...
  xaxt = 'n',
  yaxt = 'n',
  main = "Plot of 05nm Model - HDW"
)

par(xpd = TRUE)
legend(
  "right",
  legend = c("Dwarf Shrub","Shrub","moss","Lichen","Tree","Forb"),
  fill = c(
    "lightcyan3",
    "royalblue",
    "forestgreen",
...
jpeg('Outputs/2_HDW_Imagery/2_Models/Plot of 10nm Model_HDW.jpg',width=1000, height=700)
par(xpd = FALSE)
plot(
