...
##Converts to a dataframe....dim() 12 374
...
##        990          78          21         461          89         241          25 

###First we want to make the amount of scans among functional groups equivalent...I'll make it 21 since that's the lowest amount of samples we have
