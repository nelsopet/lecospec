...
Ash_test<-brick("Original_data/Test_imagery_HDW/Ash_Trees")
plot(Ash_test[[4]])

##Reads in spectral library....dim 1916  333
...
##alaskaSpeclib_HDW$PFT_3%>%table()
##Dwarf Shrub        Forb   Graminoid      Lichen        Moss       Shrub        Tree  
##        992          79          25         464          90         241          25 
...
##this function generates the principal components for "alaskaSpeclib_HDW" and "Clayton_test_HDW"
