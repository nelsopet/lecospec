...
AK2018_spectra <- readRDS("/Alaska_Spectral_Library/processed spec/AK2018/AK2018_spectra_smooth_100nm.rds")
bethelLib_spectra <- readRDS("/Alaska_Spectral_Library/processed spec/bethelLib/bethelLib_spectra_smooth_100nm.rds")
brooksLib_spectra <- readRDS("/Alaska_Spectral_Library/processed spec/brooksLib/brooksLib_spectra_smooth_100nm.rds")
Murph2_spectra <- readRDS("/Alaska_Spectral_Library/processed spec/Murph2_Lib/Murph2_spectra_smooth_100nm.rds")
Murph_lib_spectra <- readRDS("/Alaska_Spectral_Library/processed spec/Murph_lib/Murph_lib_spectra_smooth_100nm.rds")
yKDeltLib_spectra <- readRDS("/Alaska_Spectral_Library/processed spec/yKDeltLib/yKDeltLib_spectra_smooth_100nm.rds")
...
###save table
write.csv(alaskaSpecLib,"/Alaska_Spectral_Library/processed spec/AlaskaSpecLib/alaskaSpecLib_smooth_100nm.csv",row.names = FALSE)
write.csv(alaskaSpecLib_plants,"/Alaska_Spectral_Library/processed spec/AlaskaSpecLib/alaskaSpecLib_smooth_100nm_plants.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen,"/Alaska_Spectral_Library/processed spec/AlaskaSpecLib/alaskaSpecLib_smooth_100nm_lichen.csv",row.names = FALSE)
write.csv(alaskaSpecLib_bryo,"/Alaska_Spectral_Library/processed spec/AlaskaSpecLib/alaskaSpecLib_smooth_100nm_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen_bryo,"/Alaska_Spectral_Library/processed spec/AlaskaSpecLib/alaskaSpecLib_smooth_100nm_lichen_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_vascular,"/Alaska_Spectral_Library/processed spec/AlaskaSpecLib/alaskaSpecLib_smooth_100nm_vascular.csv",row.names = FALSE)
