...
Murph_lib_spectra_smooth_5nm = resample(Murph_lib_spectra_smooth, seq(350, 2500, 5))
Murph_lib_spectra_smooth_10nm = resample(Murph_lib_spectra_smooth, seq(350, 2500, 10))
Murph_lib_spectra_smooth_50nm = resample(Murph_lib_spectra_smooth, seq(350, 2500, 50))
