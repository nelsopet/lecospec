...
AK2018_spectra <- readRDS("processed spec/AK2018/AK2018_spectra_50nm.rds")
bethelLib_spectra <- readRDS("processed spec/bethelLib/bethelLib_spectra_50nm.rds")
brooksLib_spectra <- readRDS("processed spec/brooksLib/brooksLib_spectra_50nm.rds")
Murph2_spectra <- readRDS("processed spec/Murph2_Lib/Murph2_spectra_50nm.rds")
Murph_lib_spectra <- readRDS("processed spec/Murph_lib/Murph_lib_spectra_50nm.rds")
yKDeltLib_spectra <- readRDS("processed spec/yKDeltLib/yKDeltLib_spectra_50nm.rds")
...
###save table
write.csv(alaskaSpecLib,"processed spec/AlaskaSpecLib/alaskaSpecLib_50nm.csv",row.names = FALSE)
write.csv(alaskaSpecLib_plants,"processed spec/AlaskaSpecLib/alaskaSpecLib_50nm_plants.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen,"processed spec/AlaskaSpecLib/alaskaSpecLib_50nm_lichen.csv",row.names = FALSE)
write.csv(alaskaSpecLib_bryo,"processed spec/AlaskaSpecLib/alaskaSpecLib_50nm_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen_bryo,"processed spec/AlaskaSpecLib/alaskaSpecLib_50nm_lichen_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_vascular,"processed spec/AlaskaSpecLib/alaskaSpecLib_50nm_vascular.csv",row.names = FALSE)
