...
AK2018_spectra <- readRDS("processed spec/AK2018/AK2018_spectra_10nm.rds")
bethelLib_spectra <- readRDS("processed spec/bethelLib/bethelLib_spectra_10nm.rds")
brooksLib_spectra <- readRDS("processed spec/brooksLib/brooksLib_spectra_10nm.rds")
Murph2_spectra <- readRDS("processed spec/Murph2_Lib/Murph2_spectra_10nm.rds")
Murph_lib_spectra <- readRDS("processed spec/Murph_lib/Murph_lib_spectra_10nm.rds")
yKDeltLib_spectra <- readRDS("processed spec/yKDeltLib/yKDeltLib_spectra_10nm.rds")
...
###save table
write.csv(alaskaSpecLib,"processed spec/AlaskaSpecLib/alaskaSpecLib_10nm.csv",row.names = FALSE)
write.csv(alaskaSpecLib_plants,"processed spec/AlaskaSpecLib/alaskaSpecLib_10nm_plants.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen,"processed spec/AlaskaSpecLib/alaskaSpecLib_10nm_lichen.csv",row.names = FALSE)
write.csv(alaskaSpecLib_bryo,"processed spec/AlaskaSpecLib/alaskaSpecLib_10nm_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_lichen_bryo,"processed spec/AlaskaSpecLib/alaskaSpecLib_10nm_lichen_bryo.csv",row.names = FALSE)
write.csv(alaskaSpecLib_vascular,"processed spec/AlaskaSpecLib/alaskaSpecLib_10nm_vascular.csv",row.names = FALSE)
