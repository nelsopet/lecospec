...
confusion_martrix_plants<-as.data.frame(rf_plants$confusion)
...
confusion_martrix_5nm_plants<-as.data.frame(rf_5nm_plants$confusion)
...
confusion_martrix_10nm_plants<-as.data.frame(rf_10nm_plants$confusion)
...
confusion_martrix_50nm_plants<-as.data.frame(rf_50nm_plants$confusion)
...
confusion_martrix_100nm_plants<-as.data.frame(rf_100nm_plants$confusion)

###extract error rate
error_rf_PCA_plants<-as.data.frame(rf_plants$err.rate[2001,1])
names(error_rf_PCA_plants)[1]<-"all_bands"
error_rf_PCA_5nm_plants<-as.data.frame(rf_5nm_plants$err.rate[2001,1])
names(error_rf_PCA_5nm_plants)[1]<-"5nm"
error_rf_PCA_10nm_plants<-as.data.frame(rf_10nm_plants$err.rate[2001,1])
names(error_rf_PCA_10nm_plants)[1]<-"10nm"
error_rf_PCA_50nm_plants<-as.data.frame(rf_50nm_plants$err.rate[2001,1])
names(error_rf_PCA_50nm_plants)[1]<-"50nm"
error_rf_PCA_100nm_plants<-as.data.frame(rf_100nm_plants$err.rate[2001,1])
names(error_rf_PCA_100nm_plants)[1]<-"100nm"
...
##write to folder
write.csv(error_rate_PCA_plants,"Model Scripts/Error Rates/PCA/Error/error_rate_PCA_plants.csv",row.names = F)
write.csv(confusion_martrix_plants,"Model Scripts/Error Rates/PCA/Confusion Matrix/Raw/confusion_martrix_raw_plants.csv",row.names = F)
write.csv(confusion_martrix_5nm_plants,"Model Scripts/Error Rates/PCA/Confusion Matrix/Raw/confusion_martrix_5nm_plants.csv",row.names = F)
write.csv(confusion_martrix_10nm_plants,"Model Scripts/Error Rates/PCA/Confusion Matrix/Raw/confusion_martrix_10nm_plants.csv",row.names = F)
write.csv(confusion_martrix_50nm_plants,"Model Scripts/Error Rates/PCA/Confusion Matrix/Raw/confusion_martrix_50nm_plants.csv",row.names = F)
write.csv(confusion_martrix_100nm_plants,"Model Scripts/Error Rates/PCA/Confusion Matrix/Raw/confusion_martrix_100nm_plants.csv",row.names = F)
