...
names_species<-as.data.frame(as.character(alaskaSpecLib_plants$PFT_3))
...
pc6<-c(1:6)####fist 6 PC's
names_species<-as.data.frame(as.character(alaskaSpecLib_5nm_plants$PFT_3))
pca_5nm_plants<-as.data.frame(cbind(names_species,pca_5nm_plants$x[,pc6]))
names(pca_5nm_plants)[1]<-paste("PFT_3")
pca_5nm_plants$PFT_3<-as.factor(pca_5nm_plants$PFT_3)
...
pc6<-c(1:6)####fist 6 PC's
names_species<-as.data.frame(as.character(alaskaSpecLib_10nm_plants$PFT_3))
pca_10nm_plants<-as.data.frame(cbind(names_species,pca_10nm_plants$x[,pc6]))
names(pca_10nm_plants)[1]<-paste("PFT_3")
pca_10nm_plants$PFT_3<-as.factor(pca_10nm_plants$PFT_3)
...
pc6<-c(1:6)####fist 6 PC's
names_species<-as.data.frame(as.character(alaskaSpecLib_50nm_plants$PFT_3))
pca_50nm_plants<-as.data.frame(cbind(names_species,pca_50nm_plants$x[,pc6]))
names(pca_50nm_plants)[1]<-paste("PFT_3")
pca_50nm_plants$PFT_3<-as.factor(pca_50nm_plants$PFT_3)
...
pc6<-c(1:6)####fist 6 PC's
names_species<-as.data.frame(as.character(alaskaSpecLib_100nm_plants$PFT_3))
pca_100nm_plants<-as.data.frame(cbind(names_species,pca_100nm_plants$x[,pc6]))
names(pca_100nm_plants)[1]<-paste("PFT_3")
pca_100nm_plants$PFT_3<-as.factor(pca_100nm_plants$PFT_3)
...
error_rate_PCA_gen_life_form<-cbind(error_rf_PCA_plants,
