...
###extract error rate
error_rf_bryo<-as.data.frame(rf_bryo$err.rate[2001,1])
names(error_rf_bryo)[1]<-"all_bands"
error_rf_5nm_bryo<-as.data.frame(rf_5nm_bryo$err.rate[2001,1])
names(error_rf_5nm_bryo)[1]<-"5nm"
error_rf_10nm_bryo<-as.data.frame(rf_10nm_bryo$err.rate[2001,1])
names(error_rf_10nm_bryo)[1]<-"10nm"
error_rf_50nm_bryo<-as.data.frame(rf_50nm_bryo$err.rate[2001,1])
names(error_rf_50nm_bryo)[1]<-"50nm"
error_rf_100nm_bryo<-as.data.frame(rf_100nm_bryo$err.rate[2001,1])
names(error_rf_100nm_bryo)[1]<-"100nm"

###Make data frame from error rate
error_rate_bryo<-cbind(error_rf_bryo,
                       error_rf_5nm_bryo,
                       error_rf_10nm_bryo,
                       error_rf_50nm_bryo,
                       error_rf_100nm_bryo)
