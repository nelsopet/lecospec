...
names(error_rf_PCA_vascular)[1]<-"all_bands"
error_rf_PCA_5nm_vascular<-as.data.frame(rf_5nm_vascular$err.rate[2001,1])
names(error_rf_PCA_5nm_vascular)[1]<-"5nm"
error_rf_PCA_10nm_vascular<-as.data.frame(rf_10nm_vascular$err.rate[2001,1])
names(error_rf_PCA_10nm_vascular)[1]<-"10nm"
error_rf_PCA_50nm_vascular<-as.data.frame(rf_50nm_vascular$err.rate[2001,1])
names(error_rf_PCA_50nm_vascular)[1]<-"50nm"
error_rf_PCA_100nm_vascular<-as.data.frame(rf_100nm_vascular$err.rate[2001,1])
names(error_rf_PCA_100nm_vascular)[1]<-"100nm"

###Make data frame from error rate
error_rate_PCA_vascular<-cbind(error_rf_PCA_vascular,
                           error_rf_PCA_5nm_vascular,
                           error_rf_PCA_10nm_vascular,
                           error_rf_PCA_50nm_vascular,
                           error_rf_PCA_100nm_vascular)
