...
###extract error rate
error_rf_PCA_smooth_vascular<-as.data.frame(rf_smooth_vascular$err.rate[2001,1])
names(error_rf_PCA_smooth_vascular)[1]<-"smooth_all_bands"
error_rf_PCA_smooth_5nm_vascular<-as.data.frame(rf_smooth_5nm_vascular$err.rate[2001,1])
names(error_rf_PCA_smooth_5nm_vascular)[1]<-"smooth_5nm"
error_rf_PCA_smooth_10nm_vascular<-as.data.frame(rf_smooth_10nm_vascular$err.rate[2001,1])
names(error_rf_PCA_smooth_10nm_vascular)[1]<-"smooth_10nm"
error_rf_PCA_smooth_50nm_vascular<-as.data.frame(rf_smooth_50nm_vascular$err.rate[2001,1])
names(error_rf_PCA_smooth_50nm_vascular)[1]<-"smooth_50nm"
error_rf_PCA_smooth_100nm_vascular<-as.data.frame(rf_smooth_100nm_vascular$err.rate[2001,1])
names(error_rf_PCA_smooth_100nm_vascular)[1]<-"smooth_100nm"

###Make data frame from error rate
error_rate_PCA_smooth_vascular<-cbind(error_rf_PCA_smooth_vascular,
                                  error_rf_PCA_smooth_5nm_vascular,
                                  error_rf_PCA_smooth_10nm_vascular,
                                  error_rf_PCA_smooth_50nm_vascular,
                                  error_rf_PCA_smooth_100nm_vascular)
error_rate_PCA_smooth_vascular$category<-"Vascular"

##write to folder
write.csv(error_rate_PCA_smooth_vascular,"/Alaska_Spectral_Library/Models/Error Rates/PCA/error_rate_PCA_smooth_vascular.csv",row.names = F)