...
Requirements: R v4.2.3 is now the only stables environemnt for lecospec.  Rtools 4.2 is also needed to be able to use devtools, which is
required to install hsdar package (a stable, read-only copy) from CRAN on Github. Other package dependencies may need to be installed 
separately along with way, such as the shiny package.
