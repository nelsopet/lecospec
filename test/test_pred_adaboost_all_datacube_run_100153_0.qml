...
<qgis minScale="1e+08" hasScaleBasedVisibilityFlag="0" version="3.28.11-Firenze" styleCategories="AllStyleCategories" maxScale="0">
  ...
  <pipe>
    ...
    <rasterrenderer alphaBand="-1" nodataColor="" opacity="1" type="paletted" band="1">
      ...
      <colorPalette>
        <paletteEntry alpha="255" color="#440154" value="0" label="0"/>
        <paletteEntry alpha="255" color="#472c7c" value="1" label="1"/>
        <paletteEntry alpha="255" color="#3b528b" value="2" label="2"/>
        <paletteEntry alpha="255" color="#2c728e" value="3" label="3"/>
        <paletteEntry alpha="255" color="#21908d" value="4" label="4"/>
        <paletteEntry alpha="255" color="#28ae80" value="5" label="5"/>
        <paletteEntry alpha="255" color="#5dc963" value="6" label="6"/>
        <paletteEntry alpha="255" color="#abdc32" value="7" label="7"/>
        <paletteEntry alpha="255" color="#fde725" value="8" label="8"/>
      </colorPalette>
