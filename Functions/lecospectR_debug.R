...
estimate_land_cover <- function(
    ...
    print(paste0("tile file names",tile_filenames))
    ...
    print(paste0("prediction file names",prediction_filenames))
    ...
    results <- merge_tiles(
        ...
        raster_datatype = "INT2U") #raster_datatype)
...
process_tile <- function(
    ...
    if(nrow(base_df) < 2) {
        ...
        print("imputing second time complete")
        ...
        print("postprocessing prediction complete")
        base::rm(df_preprocessed)
        base::gc()
        ...
        print("Predction coverted and saved")
