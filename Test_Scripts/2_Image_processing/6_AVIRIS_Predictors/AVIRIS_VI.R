...
colnames(Clayton_test_AV_VIs)[-1:-2]<-c("Boochs"     ,   "Boochs2"  ,     "CAI"           , "CARI"     , "Carter"       , "Carter2"   ,  "Carter3"   ,   
                                        "Carter4"    ,   "Carter5"  ,     "Carter6"       , "CI"       , "CI2"          , "ClAInt"    ,  "CRI1"      ,   
                                        "CRI2"       ,   "CRI3"     ,     "CRI4"          , "D1"       , "D2"           , "Datt"      ,  "Datt2"     ,   
                                        "Datt3"      ,   "Datt4"    ,     "Datt5"         , "Datt6"    , "Datt7"        , "Datt8"     ,  "DD"        ,   
                                        "DDn"        ,   "DPI"      ,     "DWSI1"         , "DWSI2"    , "DWSI3"        , "DWSI4"     ,  "DWSI5"     ,   
...
write.csv(alaskaSpeclib_AV_VIs        ,"Outputs/3_AV_Imagery/1_Processing/alaskaSpeclib_AV_VIs.csv"        ,row.names = FALSE)
write.csv(alaskaSpeclib_AV_VIs_equal25,"Outputs/3_AV_Imagery/1_Processing/alaskaSpeclib_AV_VIs_equal25.csv",row.names = FALSE)
write.csv(Clayton_test_AV_VIs         ,"Outputs/3_AV_Imagery/1_Processing/Clayton_test_AV_VIs.csv"         ,row.names = FALSE)
