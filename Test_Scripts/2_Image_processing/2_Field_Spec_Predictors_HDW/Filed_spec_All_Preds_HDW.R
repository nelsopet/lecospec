...
alaskaSpeclib_HDW_df_equal25   <-read.csv("Test_Outputs/2_HDW_Imagery/1_Processing/alaskaSpeclib_HDW_df_equal25.csv")
alaskaSpeclib_HDW_010nm_equal25<-read.csv("Test_Outputs/2_HDW_Imagery/1_Processing/alaskaSpeclib_HDW_010nm_equal25.csv")
alaskaSpeclib_HDW_050nm_equal25<-read.csv("Test_Outputs/2_HDW_Imagery/1_Processing/alaskaSpeclib_HDW_050nm_equal25.csv")
alaskaSpeclib_HDW_100nm_equal25<-read.csv("Test_Outputs/2_HDW_Imagery/1_Processing/alaskaSpeclib_HDW_100nm_equal25.csv")
alaskaSpeclib_HDW_VIs_equal25  <-read.csv("Test_Outputs/2_HDW_Imagery/1_processing/alaskaSpeclib_HDW_VIs_equal25.csv" )

##Make names for colnames in each df unique
colnames(alaskaSpeclib_HDW_df_equal25)   [-1:-7]<-paste0(colnames(alaskaSpeclib_HDW_df_equal25   )[-1:-7],"_raw")
...
alaskaSpecLib_data_HDW<-Reduce(cbind,list(alaskaSpeclib_HDW_df_equal25
                                         ,alaskaSpeclib_HDW_010nm_equal25[-1:-7]
